export default async function handler(req, res) {
  ...
  parts: [{ text: "Eres un asistente especializado en los servicios de Carlos Fernández: impresión profesional, diseño gráfico, migración digital y educación técnica. Responde siempre en ese contexto." }]
};

const contents = [systemPrompt, ...history.map(msg => ({
